...
struct Mesh {
    ...
    std::vector<Vec3> computeCube(float scale) {
        std::vector<Vec3> cubePoints;
        ...
        cubePoints.push_back(extremBottomPoint);      //0
        cubePoints.push_back(Vec3(maxX, minY, minZ)); //1
        cubePoints.push_back(Vec3(maxX, minY, maxZ)); //2
        cubePoints.push_back(Vec3(minX, minY, maxZ)); //3
        cubePoints.push_back(Vec3(minX, maxY, maxZ)); //4
        cubePoints.push_back(extremTopPoint);         //5
        cubePoints.push_back(Vec3(maxX, maxY, minZ)); //6
        cubePoints.push_back(Vec3(minX, maxY, minZ)); //7
...
void DrawCube(std::vector<Vec3> TabPoints, long nbPoints) {

    glBegin(GL_QUADS);
    glColor3f(1., 1., 1.);
    
    glVertex3f(TabPoints[0][0],
               TabPoints[0][1],
               TabPoints[0][2]);
    glVertex3f(TabPoints[1][0],
               TabPoints[1][1],
               TabPoints[1][2]);
    glVertex3f(TabPoints[6][0],
               TabPoints[6][1],
               TabPoints[6][2]);
    glVertex3f(TabPoints[7][0],
               TabPoints[7][1],
               TabPoints[7][2]);

    glVertex3f(TabPoints[3][0],
               TabPoints[3][1],
               TabPoints[3][2]);
    glVertex3f(TabPoints[2][0],
               TabPoints[2][1],
               TabPoints[2][2]);
    glVertex3f(TabPoints[5][0],
               TabPoints[5][1],
               TabPoints[5][2]);
    glVertex3f(TabPoints[4][0],
               TabPoints[4][1],
               TabPoints[4][2]);
