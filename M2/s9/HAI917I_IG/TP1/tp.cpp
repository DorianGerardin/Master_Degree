...
void HPSS3(Vec3 &outputPoint, Vec3 &outputNormal, std::vector<Vec3> const &positions,
        ...
        for (unsigned int i = 0; i < nbIterations; ++i)
        {
            ...
            p /= wSum;
            n /= wSum;
            outputPoint = project(outputPoint, p, n);
            n.normalize();
            outputNormal = n;
...
int main (int argc, char ** argv) {
...

    {
        ...
        // TODO
        for( unsigned int pIt = 0 ; pIt < positions2.size() ; ++pIt ) {
            HPSS3(positions2[pIt], normals2[pIt], positions, normals, kdtree, 2);
        }
    }
